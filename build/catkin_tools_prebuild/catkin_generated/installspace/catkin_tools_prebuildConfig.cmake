...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosboxone/catkin_ws/src/ros_tello_driver/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rosboxone/catkin_ws/src/ros_tello_driver/install/lib;/home/rosboxone/phocoena_ws/devel/lib;/home/rosboxone/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
